...
class SelfAttention(nn.Module):
    def __init__(self, input_size, heads):
        ...
        self.keys = nn.Linear(input_size, input_size)
        self.queries = nn.Linear(input_size,input_size)
    ...
    def forward(self, values, keys, query, mask):
        ...
        attention = (attention @ values).reshape(N, query_len, self.heads * self.head_dim)
